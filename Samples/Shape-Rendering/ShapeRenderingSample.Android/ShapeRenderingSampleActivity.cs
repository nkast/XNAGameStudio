...
{
    [Activity(Label = "ShapeRenderingSample"
        , MainLauncher = true
        , Icon = "@drawable/icon"
    ...
    public class ShapeRenderingSampleActivity : Microsoft.Xna.Framework.AndroidGameActivity
    {
        protected override void OnCreate(Bundle bundle)
        {
            base.OnCreate(bundle);
            var game = new ShapeRenderingSampleGame();
