...
namespace NinjAcademy
{
    class GameplayScreen : GameScreen
    {
        ...
        private void MarkGameOver()
        {
            ...
            Rectangle viewportBounds = ScreenManager.GraphicsDevice.Viewport.Bounds;
            Vector2 gameOverDimensions = scoreFont.MeasureString(GameOverText);
            gameOverTextPosition = new Vector2(viewportBounds.Center.X - gameOverDimensions.X / 2,
                viewportBounds.Center.Y - gameOverDimensions.Y / 2);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Rectangle viewport = ScreenManager.GraphicsDevice.Viewport.Bounds;
